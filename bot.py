...
if __name__ == '__main__':
    ...
    application.run_webhook(listen="0.0.0.0", port=PORT, secret_token='b7c27da80ee14e36d4bea9c94a72f4d83edabe2956fd36d0c6fbfb1f0203', webhook_url='https://koronapay-spread.herokuapp.com/')
